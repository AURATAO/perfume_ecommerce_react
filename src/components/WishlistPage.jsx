...
function WishlistPage(){
    ...
    return(
        <div className='container pt-5 '>
            {likedProducts.length === 0 ? (<h1 className='container py-4 text-body-secondary maxWidth'>Your wishlist is empty!!!</h1>) : (<div className='productBoard m-auto row d-flex  align-items-center flex-wrap g-4 g-lg-3 pb-5 pt-[30px] justify-content-md-start justify-content-lg-start'>
